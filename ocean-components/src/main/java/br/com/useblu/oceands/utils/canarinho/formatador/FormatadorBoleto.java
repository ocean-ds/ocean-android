...
public final class FormatadorBoleto implements Formatador {
    ...
    private static final br.com.useblu.oceands.utils.canarinho.formatador.FormatadorBase FORMATADOR_TRIBUTOS = new br.com.useblu.oceands.utils.canarinho.formatador.FormatadorBase(
            TRIBUTO_FORMATADO,
            "$1 $2 $3 $4",
    ...
    private static final br.com.useblu.oceands.utils.canarinho.formatador.FormatadorBase FORMATADOR_NORMAL = new br.com.useblu.oceands.utils.canarinho.formatador.FormatadorBase(
            NORMAL_FORMATADO,
            "$1.$2 $3.$4 $5.$6 $7 $8",
            NORMAL_DESFORMATADO,
            "$1$2$3$4$5$6$7$8"
